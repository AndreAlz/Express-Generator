...
class CitiesRest implements IControllerBase {
    public service = new CitiesService();
    public repository = getCustomRepository(CitiesRepository);
    public path = "/";
    ...
    public initRoutes() {
        this.router.get("/Cities/findall", this.findall);
        this.router.post("/Cities/find", this.find);
        this.router.post("/Cities/create", this.create);
        this.router.post("/Cities/save", this.save);
        this.router.delete("/Cities/delete", this.delete);
    }
