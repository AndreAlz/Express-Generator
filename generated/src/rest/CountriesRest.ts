...
class CountriesRest implements IControllerBase {
    public service = new CountriesService();
    public repository = getCustomRepository(CountriesRepository);
    public path = "/";
    ...
    public initRoutes() {
        this.router.get("/Countries/findall", this.findall);
        this.router.post("/Countries/find", this.find);
        this.router.post("/Countries/create", this.create);
        this.router.post("/Countries/save", this.save);
        this.router.delete("/Countries/delete", this.delete);
    }
