...
class UsersRest implements IControllerBase {
    public service = new UsersService();
    public repository = getCustomRepository(UsersRepository);
    public path = "/";
    ...
    public initRoutes() {
        this.router.get("/Users/findall", this.findall);
        this.router.post("/Users/find", this.find);
        this.router.post("/Users/create", this.create);
        this.router.post("/Users/save", this.save);
        this.router.delete("/Users/delete", this.delete);
    }
