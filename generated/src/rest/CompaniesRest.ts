...
class CompaniesRest implements IControllerBase {
    public service = new CompaniesService();
    public repository = getCustomRepository(CompaniesRepository);
    public path = "/";
    ...
    public initRoutes() {
        this.router.get("/Companies/findall", this.findall);
        this.router.post("/Companies/find", this.find);
        this.router.post("/Companies/create", this.create);
        this.router.post("/Companies/save", this.save);
        this.router.delete("/Companies/delete", this.delete);
    }
