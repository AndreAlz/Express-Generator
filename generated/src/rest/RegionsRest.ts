...
class RegionsRest implements IControllerBase {
    public service = new RegionsService();
    public repository = getCustomRepository(RegionsRepository);
    public path = "/";
    ...
    public initRoutes() {
        this.router.get("/Regions/findall", this.findall);
        this.router.post("/Regions/find", this.find);
        this.router.post("/Regions/create", this.create);
        this.router.post("/Regions/save", this.save);
        this.router.delete("/Regions/delete", this.delete);
    }
