...
class IncotermsRest implements IControllerBase {
    public service = new IncotermsService();
    public repository = getCustomRepository(IncotermsRepository);
    public path = "/";
    ...
    public initRoutes() {
        this.router.get("/Incoterms/findall", this.findall);
        this.router.post("/Incoterms/find", this.find);
        this.router.post("/Incoterms/create", this.create);
        this.router.post("/Incoterms/save", this.save);
        this.router.delete("/Incoterms/delete", this.delete);
    }
