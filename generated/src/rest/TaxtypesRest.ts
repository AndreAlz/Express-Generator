...
class TaxtypesRest implements IControllerBase {
    public service = new TaxtypesService();
    public repository = getCustomRepository(TaxtypesRepository);
    public path = "/";
    ...
    public initRoutes() {
        this.router.get("/Taxtypes/findall", this.findall);
        this.router.post("/Taxtypes/find", this.find);
        this.router.post("/Taxtypes/create", this.create);
        this.router.post("/Taxtypes/save", this.save);
        this.router.delete("/Taxtypes/delete", this.delete);
    }
