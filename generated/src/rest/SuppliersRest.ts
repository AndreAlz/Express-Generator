...
class SuppliersRest implements IControllerBase {
    public service = new SuppliersService();
    public repository = getCustomRepository(SuppliersRepository);
    public path = "/";
    ...
    public initRoutes() {
        this.router.get("/Suppliers/findall", this.findall);
        this.router.post("/Suppliers/find", this.find);
        this.router.post("/Suppliers/create", this.create);
        this.router.post("/Suppliers/save", this.save);
        this.router.delete("/Suppliers/delete", this.delete);
    }
