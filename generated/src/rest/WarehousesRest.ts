...
class WarehousesRest implements IControllerBase {
    public service = new WarehousesService();
    public repository = getCustomRepository(WarehousesRepository);
    public path = "/";
    ...
    public initRoutes() {
        this.router.get("/Warehouses/findall", this.findall);
        this.router.post("/Warehouses/find", this.find);
        this.router.post("/Warehouses/create", this.create);
        this.router.post("/Warehouses/save", this.save);
        this.router.delete("/Warehouses/delete", this.delete);
    }
