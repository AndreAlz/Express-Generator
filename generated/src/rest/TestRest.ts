...
class TestRest implements IControllerBase {
    public service = new TestService();
    public repository = getCustomRepository(TestRepository);
    public path = "/";
    ...
    public initRoutes() {
        this.router.get("/Test/findall", this.findall);
        this.router.post("/Test/find", this.find);
        this.router.post("/Test/create", this.create);
        this.router.post("/Test/save", this.save);
        this.router.delete("/Test/delete", this.delete);
    }
