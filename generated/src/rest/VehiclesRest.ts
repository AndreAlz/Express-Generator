...
class VehiclesRest implements IControllerBase {
    public service = new VehiclesService();
    public repository = getCustomRepository(VehiclesRepository);
    public path = "/";
    ...
    public initRoutes() {
        this.router.get("/Vehicles/findall", this.findall);
        this.router.post("/Vehicles/find", this.find);
        this.router.post("/Vehicles/create", this.create);
        this.router.post("/Vehicles/save", this.save);
        this.router.delete("/Vehicles/delete", this.delete);
    }
