...
class SurveysRest implements IControllerBase {
    public service = new SurveysService();
    public repository = getCustomRepository(SurveysRepository);
    public path = "/";
    ...
    public initRoutes() {
        this.router.get("/Surveys/findall", this.findall);
        this.router.post("/Surveys/find", this.find);
        this.router.post("/Surveys/create", this.create);
        this.router.post("/Surveys/save", this.save);
        this.router.delete("/Surveys/delete", this.delete);
    }
