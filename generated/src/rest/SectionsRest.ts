...
class SectionsRest implements IControllerBase {
    public service = new SectionsService();
    public repository = getCustomRepository(SectionsRepository);
    public path = "/";
    ...
    public initRoutes() {
        this.router.get("/Sections/findall", this.findall);
        this.router.post("/Sections/find", this.find);
        this.router.post("/Sections/create", this.create);
        this.router.post("/Sections/save", this.save);
        this.router.delete("/Sections/delete", this.delete);
    }
