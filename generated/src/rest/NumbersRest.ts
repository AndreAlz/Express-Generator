...
class NumbersRest implements IControllerBase {
    public service = new NumbersService();
    public repository = getCustomRepository(NumbersRepository);
    public path = "/";
    ...
    public initRoutes() {
        this.router.get("/Numbers/findall", this.findall);
        this.router.post("/Numbers/find", this.find);
        this.router.post("/Numbers/create", this.create);
        this.router.post("/Numbers/save", this.save);
        this.router.delete("/Numbers/delete", this.delete);
    }
