...
class DocumentsRest implements IControllerBase {
    public service = new DocumentsService();
    public repository = getCustomRepository(DocumentsRepository);
    public path = "/";
    ...
    public initRoutes() {
        this.router.get("/Documents/findall", this.findall);
        this.router.post("/Documents/find", this.find);
        this.router.post("/Documents/create", this.create);
        this.router.post("/Documents/save", this.save);
        this.router.delete("/Documents/delete", this.delete);
    }
