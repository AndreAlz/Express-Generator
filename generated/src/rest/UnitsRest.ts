...
class UnitsRest implements IControllerBase {
    public service = new UnitsService();
    public repository = getCustomRepository(UnitsRepository);
    public path = "/";
    ...
    public initRoutes() {
        this.router.get("/Units/findall", this.findall);
        this.router.post("/Units/find", this.find);
        this.router.post("/Units/create", this.create);
        this.router.post("/Units/save", this.save);
        this.router.delete("/Units/delete", this.delete);
    }
